...
class Kanton {
	...
	public function getKantonArray() {
		return $this->kanton;
	}
	
	public function getKantonByKennzeichen($kennzeichen) {
		foreach ($this->kanton as $entry) {
			if (strcmp($entry["Kürzel"], $kennzeichen) == 0) {
				return $entry;
			}
		}
		return 0;
